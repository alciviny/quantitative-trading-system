...
# -*- coding: utf-8 -*-
"""
walk_forward_extended_lookback.py
Walk-Forward com lookback maior: 12 meses TREINO + 3 meses TESTE
Aumenta dados históricos para indicadores funcionarem melhor
"""
...
logger = logging.getLogger("walk_forward_ext")
...
def main():
    setup_logging()
    parser = argparse.ArgumentParser(description='Walk-Forward com LOOKBACK ESTENDIDO (12m treino)')
    ...
    parser.add_argument('--out', type=str, default='walk_forward_extended_results.csv')
    ...
    logger.info('CONFIGURAÇÃO: 12 meses TREINO + 3 meses TESTE')
    ...
    # Gera janelas (12 meses treino + 3 meses teste, avanço trimestral)
    windows = []
    current = min_date
    
    while True:
        # Adiciona 12 meses para treino
        ...
        # Avança 3 meses (trimestral, mais rápido)
    ...
    if all_trades:
        ...
        print('\n' + '=' * 70)
        print('🔄 WALK-FORWARD COM LOOKBACK ESTENDIDO (12 meses treino)')
        print('=' * 70)
