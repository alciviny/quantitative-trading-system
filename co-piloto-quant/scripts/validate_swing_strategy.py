...
# -*- coding: utf-8 -*-
"""
validate_swing_strategy.py
Walk-Forward para MeanReversionSwingStrategy (2022-2025, CALM only)
"""
...
logger = logging.getLogger("validate_swing")
...
def main():
    setup_logging()
    parser = argparse.ArgumentParser(description='Validação MeanReversionSwing (2022-2025)')
    ...
    parser.add_argument('--out', type=str, default='swing_strategy_results.csv')
    ...
    logger.info('CONFIGURAÇÃO: 12 meses TREINO + 3 meses TESTE (2022-2025, CALM only)')
    ...
    if all_trades:
        ...
        print('\n' + '=' * 70)
        print('VALIDACAO: MEAN REVERSION SWING (2022-2025, CALM ONLY)')
        print('=' * 70)
